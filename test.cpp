...
int main(int argc, char* argv[]) {
        ...
        */
        ...
        EthArpPacket packet = Make_packet(interfaceName , macAddress ,sip,tip);

        // packet.eth_.dmac_ = Mac(getSMAC(argv[2],interfaceName,macAddress,argv[3]));
